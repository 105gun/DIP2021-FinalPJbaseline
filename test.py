...
if __name__ == '__main__':
    ...
    parser.add_argument('--test-files', type=str, default='./filelists/ShanghaiA_test.txt')
    parser.add_argument('--best-model', type=str, default='./checkpoints/demo/bestvalmodel.pth')
